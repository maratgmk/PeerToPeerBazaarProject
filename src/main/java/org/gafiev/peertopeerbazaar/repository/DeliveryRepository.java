...
public interface DeliveryRepository extends JpaRepository<Delivery,Long> {
    /**
     * запрос выборок поставок из БД одинаковыми статусами, с одинаковым адресом забора и с одинаковым адресом доставки,
     ...
     * @return подмножества из множества всех доставок, выбранные по указанным параметрам
     */
